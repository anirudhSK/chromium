...

{
  ...
  'targets': [
	...
	'http/failing_http_transaction_factory.h',
        ...
        'quic/congestion_control/my_tcp_cubic_sender.cc',
        'quic/congestion_control/my_tcp_cubic_sender.h',
        'quic/congestion_control/my_tcp_receiver.cc',
        'quic/congestion_control/my_tcp_receiver.h',
