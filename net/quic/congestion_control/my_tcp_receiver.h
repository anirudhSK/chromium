...
#ifndef NET_QUIC_CONGESTION_CONTROL_MY_TCP_RECEIVER_H_
#define NET_QUIC_CONGESTION_CONTROL_MY_TCP_RECEIVER_H_
...
class NET_EXPORT_PRIVATE MyTcpReceiver : public ReceiveAlgorithmInterface {
 public:
  MyTcpReceiver();
...
#endif  // NET_QUIC_CONGESTION_CONTROL_MY_TCP_RECEIVER_H_
